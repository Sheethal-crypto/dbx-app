...
def save_vehicle(decoded):
    """Write an already decoded vehicle to the garage. Returns it with its id."""
...
def add_vehicle(vin):
    ...
    """
    return save_vehicle(decoded=decode_vin(vin=vin))
